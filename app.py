...
st.title('Tiltle -> hello world')                       # title
st.header('header -> hi hello')                         # header
st.subheader('subheader -> welcome')                    # Subheader
st.text('Text -> GeeksForGeeks')                        # Text

st.markdown('# hi')                                     # Markdown

st.success('Data submitted')                            # success
...
radioButton = st.radio('Select : ', ('Male','Female','Other','prefer not to say'))
if(radioButton == 'Male'):
...
elif(radioButton == 'prefer not to say'):
    st.write("You dont want to disclose your gender")

st.subheader('Select Box')                              # SelectBox
selectBox =  st.selectbox("Data Science : ", [  'Data Analsis', 'Web Scraping','Machine Learning',
                                                'Deep Learning','Natural Language Processing',                                                                                                                                                'Computer Vision','Image Processing','Ms Excel','Python','Maths'])
